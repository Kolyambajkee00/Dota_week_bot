...
HEROES_DATA = {
    ...
    82: ("Meepo", "meepo"),
    83: ("Treant Protector", "treant_protector"),
...
def get_hero_name(hero_id: int) -> str:
    data = HEROES_DATA.get(hero_id)
    return data[0] if data else f"Герой {hero_id}"

def get_hero_image_name(hero_id: int) -> str:
    data = HEROES_DATA.get(hero_id)
    if data:
        return data[1]
